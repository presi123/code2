...
#print the transition probs of a state. P(s'|s,a). Gives the prob of moving to state s' from state s by performing action a. 
...
#generate multiple episodes with a random policy for 20 time-steps
for i in range(10):
    env.reset()
    ret = 0
    num_timesteps = 20
